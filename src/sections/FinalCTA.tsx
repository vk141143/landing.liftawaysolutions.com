...
export default function FinalCTA() {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full min-h-[80vh] flex items-center justify-center py-20 px-6 overflow-hidden"
    >
      {/* Animated Background */}
      <motion.div
      ...
      <div className="relative w-full max-w-4xl text-center">
        ...
        >
          <motion.button
            ...
            className="px-10 py-4 bg-white text-[#0F5132] rounded-full font-bold text-lg shadow-xl hover:shadow-2xl transition-shadow"
          >
            Get Started Now
          </motion.button>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="px-10 py-4 bg-white/10 backdrop-blur-sm text-white border-2 border-white/30 rounded-full font-bold text-lg hover:border-white/50 transition-colors"
          >
            Learn More
          </motion.button>
        </motion.div>
